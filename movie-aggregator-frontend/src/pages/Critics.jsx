        ...
        <div className="relative">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl mb-1 group-hover:text-accent-400 transition-colors">
                  {critic.username}
                </h3>
          ...
          <div className="grid grid-cols-2 gap-4 mt-5">
            <div className="bg-gradient-to-br from-primary-700 to-primary-800 rounded-xl p-4 border border-secondary-700/50 hover:border-accent-500/50 transition-all duration-300">
              ...
              <p className="text-white text-2xl font-bold">{critic.review_count || 0}</p>
            </div>
    ...
    return (
      <div className="min-h-screen bg-slate-900/50 text-slate-300 p-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-white mb-8">Критики</h1>
          <p>Загрузка...</p>
        </div>
      </div>
    )
